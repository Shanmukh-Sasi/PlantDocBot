  ...
  return (
    <nav style={{
      ...
      <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none', color: '#fff' }}>
        <div style={{ color: 'var(--primary)' }}><IconLeaf /></div>
        <span style={{ fontSize: '1.4rem', fontWeight: '800', letterSpacing: '-0.5px' }}>PlantDoc<span style={{ color: 'var(--primary)', fontWeight: '400' }}>.ai</span></span>
      </Link>
